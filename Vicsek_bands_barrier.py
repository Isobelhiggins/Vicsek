...
barrier_x_start, barrier_x_end = 30, 70
barrier_y_start, barrier_y_end = 30, 70
...
anim.save("Vicsek_bands_barrier.mp4", writer = writer, dpi = 100)
plt.show()
...
plt.savefig("barrier_alignment_9.png")
plt.show()
...
plt.savefig("barrier_densitymap_9.png")
plt.show()
